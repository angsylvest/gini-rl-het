...
class GR_Actor(nn.Module):
    ...
    def __init__(self, 
        ...
        print(" mlb_base_in_dim: ", mlp_base_in_dim)  # 16 + 6 = 22
        ...
        # prints the architecture of the mlp base
        print(" architecture of mlp base output: ", self.base)
    ...
    def forward(self, 
        ...
        if (self.split_batch) and (obs.shape[0] > self.max_batch_size):
            ...
            print()
            print("****************************************************************************************")
            print("In the forward from the before adding nbd feature in graph ACTOR, we are getting")
            ...
            print()
            print("****************************************************************************************")         
            print(" Here is after concatination and before MLP: actor_features shape: ", actor_features.shape)
            print("************************* ************************************ *************************")
            print()   
            ...
            print()
            print("****************************************************************************************")         
            print(" Here is what they have after concatination: actor_features shape: ", actor_features.shape)
            print("************************* ************************************ *************************")
            print()              
            
        if self._use_naive_recurrent_policy or self._use_recurrent_policy:
            actor_features, rnn_states = self.rnn(actor_features, rnn_states, masks)
            print(" actor_features shape after rnn: ", actor_features.shape)
