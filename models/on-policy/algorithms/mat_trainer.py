...
class MATTrainer:
    ...
    def ppo_update(self, sample):
        ...
        share_obs_batch, obs_batch, node_obs_batch, adj_batch, \
        ...
        # --- commented out from transformer, but need graph buffer ---                  
        ...
        values, action_log_probs, dist_entropy = self.policy.evaluate_actions(cent_obs = share_obs_batch,
                                                                        ...
                                                                        share_agent_id = share_agent_id_batch,
    ...
    def train(self, buffer):
        ...
        print('adv cope', advantages_copy.shape)
        
        # resizing to revert to original size 
        advantages_copy = advantages_copy[1:, :, -self.num_agents:, : ]
        ...
        for _ in range(self.ppo_epoch):
            ...
            data_generator = buffer.feed_forward_generator(advantages, self.num_mini_batch) # Graph 
